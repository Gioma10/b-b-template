    ...
    <section className="relative py-28 bg-navy-800 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {rooms.map((room, i) => (
            <ScrollReveal key={room.name} from="bottom" delay={i * 0.15} duration={0.7}>
              <div
              ...
              >
                ...
                <div className="bg-navy-700 p-7 group-hover:bg-navy-600 transition-colors duration-500">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button asChild variant={room.featured ? "gold" : "outline"} size="sm">
        ...
        <ScrollReveal from="fade" delay={0.3} duration={0.6} className="text-center mt-12">
